"use strict";
(globalThis["webpackChunkexpi"] = globalThis["webpackChunkexpi"] || []).push([["main-stories"],{

/***/ "./stories/main.stories.js":
/*!*********************************!*\
  !*** ./stories/main.stories.js ***!
  \*********************************/
...
/* harmony import */ var _components_expi__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/expi */ "./components/expi.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  title: 'Expi',
  component: _components_expi__WEBPACK_IMPORTED_MODULE_1__["default"]
});
var Template = function (args) {
  var _useState = _sliced_to_array((0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false), 2),
    inview = _useState[0],
    setinview = _useState[1];
  var _useState1 = _sliced_to_array((0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(0), 2),
    percentage = _useState1[0],
    setpercentage = _useState1[1];
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", {
    ...
    onClick: function () {
      return setinview(!inview);
    }
  }, "hello"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_expi__WEBPACK_IMPORTED_MODULE_1__["default"], _object_spread_props(_object_spread({
    style: {
      left: 400,
      top: 200
    }
...
var flipIcon = true;
var transition = 1;
var distributionQuadrants = [2, 3, 2, 3];
var bits = 10;
var widthCoverage = 0.9;
var increment = 0.005;
var heightCoverage = 0.8;
var iconSize = 90;
var maxexpansion = 1.4;
var icons = ['./icons/1.png', './icons/2.png', './icons/3.png', './icons/4.png', './icons/5.png'];
...
Default.args = {
  ...
  distributionQuadrants: distributionQuadrants,
  bits: bits,
...
Default.parameters = {
  ...
  docs: {
    ...
    source: {
      originalSource: "args => {\n  const [inview, setinview] = useState(false);\n  const [percentage, setpercentage] = useState(0);\n  return <>\n            <button style={{\n      position: 'absolute',\n      left: '0'\n    }} onClick={() => setinview(!inview)}>hello</button>\n\n            <Expi style={{\n      left: 400,\n      top: 200\n    }} {...args} {...{\n      inview,\n      setinview,\n      percentage,\n      setpercentage\n    }} />\n        </>;\n}",
...
// import './App.css';
function Expi(param) {
    var explode = param.explode, percentage = param.percentage, maxexpansion = param.maxexpansion, setpercentage = param.setpercentage, flipIcon = param.flipIcon, inputstyles = param.style, inview = param.inview, setinview = param.setinview, transition = param.transition, distributionQuadrants = param.distributionQuadrants, bits = param.bits, widthCoverage = param.widthCoverage, increment = param.increment, heightCoverage = param.heightCoverage, iconSize = param.iconSize, icons = param.icons;
    //THE STATES
    var _useState = _sliced_to_array((0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]), 2), iconsRendered = _useState[0], seticonsrendered = _useState[1];
    //THE CONFIGS
    //THE STYLINGS
    var styles = {
        mainContainer: {
    ...
    return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
        style: _object_spread({}, styles.mainContainer, inputstyles)
        ...
        return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Func, {
            style: {
                opacity: percentage == 0 || !inview ? '0' : '100%',
...
//# sourceMappingURL=main-stories.iframe.bundle.js.map