...
// import './App.css';
function Expi(param) {
    var explode = param.explode, flipIcon = param.flipIcon, transition = param.transition, distributionQuadrants = param.distributionQuadrants, bits = param.bits, widthCoverage = param.widthCoverage, increment = param.increment, heightCoverage = param.heightCoverage, iconSize = param.iconSize, icons = param.icons;
    //THE STATES
    ...
    var _useState2 = _sliced_to_array((0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false), 2), inview = _useState2[0], setinview = _useState2[1];
    //THE CONFIGS
    //THE STYLINGS
    var styles = {
        mainContainer: {
...
//# sourceMappingURL=main-stories.ac373614ce49ed273c03.hot-update.js.map